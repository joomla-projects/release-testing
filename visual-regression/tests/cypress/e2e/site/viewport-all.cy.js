...
const sizes = ['iphone-x', 'ipad-2', [1024, 768], 'macbook-15'];
const sizenames = ['phone [375x812]', 'tablet [768x1024]', 'laptop [1024x768]', 'desktop [1440x900]']
...
describe('Visual Regression Tests', () => {
  ...
  sizes.forEach((sizeViewport, indexSize) => {
    var sizeName = sizenames[indexSize];
    context(`Device: ${sizenames[indexSize]}`, () => {
      csvSitemap.forEach((row) => {
        context(`Page: ${row['Name']}`, () => {
